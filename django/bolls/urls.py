...
# User management and authentication endpoints (stay at root level)
user_urlpatterns = [
...
bible_urlpatterns = [
    ...
    path(
        "get-verse/<slug:translation>/<slug:book>/<int:chapter>/<int:verse>/",
        views.get_a_verse,
    ),
    path("get-bookmarks/<slug:translation>/<slug:book>/<int:chapter>/", views.get_bookmarks),
    ...
    # Catch-all search endpoint
    path("<slug:translation>/<str:piece>/", views.search),
]

# Main URL patterns - export for inclusion in bain/urls.py
